...
import com.example.ISOFTBlockchain.wsclient.message.MessageDecoder;
import com.example.ISOFTBlockchain.wsclient.message.MessageEncoder;
...
public class Client {
    ...
    public void onMessage(Session session, Object message) throws IOException {
        ...
        if (msgFromServer != null) {
            if (msgFromServer.getContent() != null) {
                ...
                if (msgFromServer.getType().equals(MessageType.SET_BLOCKCHAIN)) {
    ...
    public void handleSetBlockchainRequest(Message message) throws JsonProcessingException {
